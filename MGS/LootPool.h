...
inline TArray<LootItemInfo> AssaultRifleForChest() {
    ...
    // Heavy AR
    AssaultRifleForChest.Add({ StaticLoadObject<UFortItemDefinition>("/Game/Athena/Items/Weapons/WID_Assault_Heavy_Athena_UC_Ore_T03.WID_Assault_Heavy_Athena_UC_Ore_T03"), 20 });
    AssaultRifleForChest.Add({ StaticLoadObject<UFortItemDefinition>("/Game/Athena/Items/Weapons/WID_Assault_Heavy_Athena_R_Ore_T03.WID_Assault_Heavy_Athena_R_Ore_T03"), 15 });
    AssaultRifleForChest.Add({ StaticLoadObject<UFortItemDefinition>("/Game/Athena/Items/Weapons/WID_Assault_Heavy_Athena_VR_Ore_T03.WID_Assault_Heavy_Athena_VR_Ore_T03"), 5 });
    AssaultRifleForChest.Add({ StaticLoadObject<UFortItemDefinition>("/Game/Athena/Items/Weapons/WID_Assault_Heavy_Athena_SR_Ore_T03.WID_Assault_Heavy_Athena_SR_Ore_T03"), 2 });
...
inline TArray<LootItemInfo> SniperForChest() {
    ...
    SniperForChest.Add({ StaticLoadObject<UFortItemDefinition>("/Game/Athena/Items/Weapons/WID_Sniper_Heavy_Athena_UC_Ore_T03.WID_Sniper_Heavy_Athena_UC_Ore_T03"), 20 });
    SniperForChest.Add({ StaticLoadObject<UFortItemDefinition>("/Game/Athena/Items/Weapons/WID_Sniper_Heavy_Athena_R_Ore_T03.WID_Sniper_Heavy_Athena_R_Ore_T03"), 15 });
    SniperForChest.Add({ StaticLoadObject<UFortItemDefinition>("/Game/Athena/Items/Weapons/WID_Sniper_Heavy_Athena_VR_Ore_T03.WID_Sniper_Heavy_Athena_VR_Ore_T03"), 5 });
    SniperForChest.Add({ StaticLoadObject<UFortItemDefinition>("/Game/Athena/Items/Weapons/WID_Sniper_Heavy_Athena_SR_Ore_T03.WID_Sniper_Heavy_Athena_SR_Ore_T03"), 2 });
...
inline TArray<LootItemInfo> RPGForChest() {
    ...
    //RPG
    RPGForChest.Add({ StaticLoadObject<UFortItemDefinition>("/Game/Athena/Items/Weapons/WID_Launcher_Rocket_Athena_VR_Ore_T03.WID_Launcher_Rocket_Athena_VR_Ore_T03"), 6 });
    RPGForChest.Add({ StaticLoadObject<UFortItemDefinition>("/Game/Athena/Items/Weapons/WID_Launcher_Rocket_Athena_SR_Ore_T03.WID_Launcher_Rocket_Athena_SR_Ore_T03"), 2 });
...
inline TArray<ConsumableInfo> Consumable() {
    ...
    ConsumableInfo CrashPadInfo;
    CrashPadInfo.Definition = StaticLoadObject<UFortItemDefinition>("/Game/Athena/Items/Consumables/AppleSun/WID_Athena_AppleSun.WID_Athena_AppleSun");
    CrashPadInfo.Quantity = 3;
    Consumable.Add(CrashPadInfo);
